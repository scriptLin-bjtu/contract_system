...
import { GetFinalDrafts, SubmitFinalDraft, getUsersByPermission } from '../../services/api.js';
...
export default function FinalizeContract() {
	...
	const {can_finalize_contract}=useSelector((state) => state.userPermission.permission);
    useEffect(() => {
