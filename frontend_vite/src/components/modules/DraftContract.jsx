...
import { Draft, getUsersByPermission } from '../../services/api.js';
...
export default function DraftContract() {
  ...
  const {can_draft_contract} = useSelector((state) => state.userPermission.permission);
