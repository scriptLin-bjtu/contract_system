...
import {GetDraft, SetCountersigner} from '../../services/api.js';
...
export default function ManageDraftContract() {
    ...
    const handleOk = async () => {
        try {
            ...
            console.log('指定会签人:', values.signers);
			const formdata={id:currentContract.id,users:values.signers};
        ...
        <div>
            ...
            >
                <Form form={form} layout="vertical">
                    ...
                    >
                        <Input placeholder="输入会签人，可以是多个，用分号分隔" />
                    </Form.Item>
                </Form>
            </Modal>
        </div>
